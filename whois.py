...
def process_whois_content(content: str):
      ...
      lines = [line for line in list(set(allen.splitlines())) if banned.lower() not in line.lower() and line.strip() != "" and matches_whois(line)]
...
def get_whois_json_content(address: str):
    ...
    if content:
        dict_allen = process_whois_content(allen)
